 ...
 * @author facue
 */
public class newAbilitieEvo extends javax.swing.JInternalFrame {
     ...
     */
    public newAbilitieEvo() {
        initComponents();
        this.setTitle("New abilitie evolution");
    }
    ...
    private void btnAddAbilitieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddAbilitieActionPerformed
        ...
        if (controlador.getModelo().addAbilitieToEvolution(controlador.getModelo().getIdFromAbilitieName(controlador.getModelo().addAbilitieEvo())))
        {
